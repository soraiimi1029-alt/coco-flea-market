...
import { SKY_3_4_HOTSPOTS, findHotspot, estimateHighlightWidth } from "@/lib/map-data";
...
function SkyMapContent() {
  ...
  const highlightWidth = targetHotspot ? estimateHighlightWidth(SKY_3_4_HOTSPOTS, targetHotspot, 1128 / 1596) : 0;
  ...
  return (
    <div className="w-full sm:max-w-[390px] sm:mx-auto bg-bg min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center pb-24">
        <ZoomableImage src="/map/sky-3-4.jpg" alt="スカイブース 91〜100番">
          {targetHotspot && (
            <span
