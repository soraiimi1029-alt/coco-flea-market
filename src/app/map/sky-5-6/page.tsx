...
import { SKY_5_6_HOTSPOTS, findHotspot, estimateHighlightWidth } from "@/lib/map-data";
...
function SkyMapContent() {
  ...
  const highlightWidth = targetHotspot ? estimateHighlightWidth(SKY_5_6_HOTSPOTS, targetHotspot, 1128 / 1596) : 0;
